...
from src.infrastructure.performance.connection_pool import ConnectionPool, QueryOptimizer
...
class TestConnectionPool(unittest.TestCase):
    ...
    def test_connection_timeout(self):
        ...
        with self.assertRaises(TimeoutError), self.pool.get_connection(timeout=0.1):
            pass
