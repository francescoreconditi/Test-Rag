...
class HybridRetriever:
    ...
    def add_documents(self, 
                     ...
                     metadata_field: str = "metadata") -> None:
        ...
        for i, doc in enumerate(documents):
            ...
            if self.embedding_model:
                try:
                    ...
                    embedding = np.zeros(384)  # Fallback empty embedding
    ...
    def search(self, 
               ...
               final_rerank_k: int = 10) -> List[RetrievalResult]:
    ...
    def optimize_weights(self, 
        ...
        for i in range(steps + 1):
            ...
            for query, rel_scores in zip(queries, relevance_scores):
                ...
                dcg = sum(rel_score / np.log2(pos + 2) 
                         for pos, rel_score in enumerate(rel_scores[:len(results)]))
                total_score += dcg
