...
from ...domain.services.calculation_engine import CalculatedMetric, CalculationEngine
from ...domain.services.data_quality_service import DataQualityService, ValidationResult
...
from ...domain.value_objects.source_reference import ProvenancedValue, SourceReference
    ...
    def _calculate_overall_confidence(self, enhanced_data: dict[str, Any],
        ...
        try:
            ...
            for validation_name, validation_result in quality_results.items():
                ...
                if hasattr(validation_result, 'failed_count') and validation_result.failed_count > 0:
